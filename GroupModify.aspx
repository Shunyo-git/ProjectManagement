									...
									<TD><FONT face="新細明體">
											<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
												<TR>
													...
													<TD class="item-text" height="20"><FONT face="新細明體"><asp:textbox id="txtName" runat="server" CssClass="standard-text" MaxLength="50" Width="180px"></asp:textbox><asp:requiredfieldvalidator id="ProjectNameRequiredfieldvalidator" runat="server" ErrorMessage="群組名稱不得空白." ControlToValidate="txtName"
												...
												<TR>
													...
													<TD class="item-text" vAlign="top" height="20"><FONT face="新細明體"><asp:textbox id="txtDescription" runat="server" CssClass="standard-text" TextMode="MultiLine"
												...
												<TR>
													...
													<TD class="item-text" vAlign="top" height="20"><asp:listbox id="Members" runat="server" Width="220px" DataValueField="UserID" DataTextField="UserName"
															SelectionMode="Multiple" Height="122px" rows="9" cssclass="box"></asp:listbox><FONT face="新細明體">(多選時請按住Ctrl鍵進行點選)</FONT>
													</TD>
												</TR>
												<TR>
													<TD class="header-item" align="right" width="120" height="20">&nbsp;</TD>
